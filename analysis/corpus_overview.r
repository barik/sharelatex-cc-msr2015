...
plot(x,y1,type="l",col="red",log="x", xlab="Number of cells", ylab="Spreadsheets with # Input Cells")
axis(1, at=c(1,10,100,1000,10000,100000), labels=c("1","10","100","1000","10000","100000"))
par(new=TRUE)
plot(x, y2,,type="l",col="blue",xaxt="n",yaxt="n",xlab="",ylab="",log="x", lty=2)
axis(4)
mtext("Spreadsheets with # Formula Cells",side=4,line=3)
